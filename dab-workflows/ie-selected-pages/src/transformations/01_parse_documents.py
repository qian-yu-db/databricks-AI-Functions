...
dbutils.widgets.text(
    "source_volume_path",
    "/Volumes/fins_genai/unstructured_documents/ie_selected_pages_workflow/inputs/",
    "Source volume path",
)
dbutils.widgets.text(
    "output_volume_path",
...
dbutils.widgets.text(
    "checkpoint_location",
    "/Volumes/fins_genai/unstructured_documents/checkpoints/ie_selected_pages_workflow/01_parse_documents",
    "Checkpoint location",
)
dbutils.widgets.text("table_name", "ie_parsed_documents_raw", "Output table name")
...
# Define schema for binary files
