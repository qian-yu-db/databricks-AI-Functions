...
# ── Stage 1: Parse PDF documents ────────────────────────────────────────────
@dp.materialized_view(
    name="batch_sdp_bronze_parsed_docs",
    comment="Raw parsed PDF documents with ai_parse_document v2.0",
)
def batch_sdp_bronze_parsed_docs():
    return (
...
# ── Stage 2: Classify documents by type ─────────────────────────────────────
@dp.materialized_view(
    name="batch_sdp_silver_classified_docs",
    comment="Documents classified by type using ai_classify v2",
)
def batch_sdp_silver_classified_docs():
    return (
        spark.read.table("batch_sdp_bronze_parsed_docs")
...
@dp.materialized_view(
    name="batch_sdp_gold_invoices",
    comment="Extracted invoice details using ai_extract v2",
)
def batch_sdp_gold_invoices():
    return (
        spark.read.table("batch_sdp_silver_classified_docs")
...
@dp.materialized_view(
    name="batch_sdp_gold_bank_statements",
    comment="Extracted bank statement details using ai_extract v2",
)
def batch_sdp_gold_bank_statements():
    return (
        spark.read.table("batch_sdp_silver_classified_docs")
...
@dp.materialized_view(
    name="batch_sdp_gold_contracts",
    comment="Extracted contract details using ai_extract v2",
)
def batch_sdp_gold_contracts():
    return (
        spark.read.table("batch_sdp_silver_classified_docs")
...
@dp.materialized_view(
    name="batch_sdp_gold_sec_filings",
    comment="Extracted SEC filing details using ai_extract v2",
)
def batch_sdp_gold_sec_filings():
    return (
        spark.read.table("batch_sdp_silver_classified_docs")
